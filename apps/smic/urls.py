...
from apps.smic.views import index, smic_view, escenario_base, EscenarioBase_list, EscenarioBase_edit, EscenarioBase_Delete, HipotesisCreate, HipotesisPrueba, HipotesisList, HipotesisCalificacionSimple, HipotesisCalificacionCompuesta, Hipotesis_Compuesta_Create
...
urlpatterns = [
    ...
    url(r'^hip_comp_nuevo$', Hipotesis_Compuesta_Create, name='escenario_compuesto_crear'),
